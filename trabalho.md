...
- Trabalho e apresentação são em grupo. **A nota é individual**: na apresentação, cada integrante responde uma pergunta específica sobre a parte que ele mesmo construiu (o prompt que escreveu, os dados que coletou). Quem não souber a1explicar sua própria parte perde nota, mesmo que o grupo entregue tudo certo.
